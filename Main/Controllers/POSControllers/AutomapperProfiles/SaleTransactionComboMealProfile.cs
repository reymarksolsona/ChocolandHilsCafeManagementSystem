...
{
    public class SaleTransactionComboMealProfile : Profile
    {
        public SaleTransactionComboMealProfile()
        {
            CreateMap<SaleTransactionComboMealModel, SaleTransactionComboMealModel>()
